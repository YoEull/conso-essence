...
const translations = {
  fr: {
    ...
    connectedAppsTitle: "Assistants connectés",
    connectedAppsDescription: "Les assistants IA (Claude, ChatGPT…) autorisés à lire et enregistrer vos pleins.",
    noConnectedApps: "Aucun assistant connecté.",
    connectedSince: "Autorisé le",
    connected: "Connecté",
    disconnect: "Déconnecter",
    confirmDisconnect: "Retirer l'accès de cet assistant ? Il ne pourra plus lire ni écrire vos données tant que vous ne l'autorisez pas de nouveau.",
    connectAssistant: "Connecter un assistant",
    connectSteps: "Dans votre assistant (Claude, ChatGPT…), ajoutez un connecteur personnalisé avec l'adresse ci-dessous, connectez-vous puis autorisez l'accès.",
    copy: "Copier",
    copied: "Copié",
  },
  en: {
    ...
    connectedAppsTitle: "Connected assistants",
    connectedAppsDescription: "AI assistants (Claude, ChatGPT…) allowed to read and record your fill-ups.",
    noConnectedApps: "No assistant connected.",
    connectedSince: "Authorized on",
    connected: "Connected",
    disconnect: "Disconnect",
    confirmDisconnect: "Remove this assistant's access? It won't be able to read or write your data until you authorize it again.",
    connectAssistant: "Connect an assistant",
    connectSteps: "In your assistant (Claude, ChatGPT…), add a custom connector with the address below, sign in, then authorize access.",
    copy: "Copy",
    copied: "Copied",
  },
} as const;
